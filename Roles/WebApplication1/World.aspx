<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="World.aspx.cs" Inherits="WebApplication1.World" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>World News</h3>
    <!-- LISTING OF APPROVED ARTICLES OF TYPE WORLD -->
    <ol class="round">
        <li class="one">
