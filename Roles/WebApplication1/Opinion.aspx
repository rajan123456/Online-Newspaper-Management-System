<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Opinion.aspx.cs" Inherits="WebApplication1.Opinion" %>
    ...
    <section class="featured">
        <div class="content-wrapper">
                ...
                <ul>
                    ...
                    <li class='active'><a href='#'><span>Opinion</span></a></li>
                </ul>
            </div>
        </div>
    </section>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Opinion News</h3>
    <!-- APPROVED OPINION ARTICLES LISTED HERE -->
    <ol class="round">
        <li class="one">
