...
namespace WebApplication1
{
    ...
    {   //FETCH APPROVED ARTICLES OF ENTERTAINMENT TYPE ON PAGE LOAD
        protected void Page_Load(object sender, EventArgs e)
        {
            FetchArticleByType();
        }
        //FETCH APPROVED ARTICLES OF ENTERTAINMENT TYPE FROM DATABASE
        private void FetchArticleByType()
        {
            ...
            using (conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ServerConnection"].ConnectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@type", "Entertainment");
