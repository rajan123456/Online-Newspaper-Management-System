...
namespace WebApplication1
{
    ...
    {   //FETCH APPROVED SCIENCE ARTICLES ON PAGE LOAD
        protected void Page_Load(object sender, EventArgs e)
        {
            FetchArticleByType();
        }
        //FETCH APPROVED SCIENCE ARTICLES FROM DATABASE
        private void FetchArticleByType()
        {
            ...
            using (conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ServerConnection"].ConnectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@type", "Science");
        ...
        //DISPLAY ARTICLE HEADLINES ON PAGE
