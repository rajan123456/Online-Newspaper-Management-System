<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Entertainment.aspx.cs" Inherits="WebApplication1.Entertainment" %>
...
<section class="featured">
        <div class="content-wrapper">
                ...
                <ul>
                    ...
                    <li class='active'><a href='#'><span>Entertainment</span></a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- APPROVED ARTICLES OF ENTERTAINMENT TYPE -->
