<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sports.aspx.cs" Inherits="WebApplication1.Sports" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Sports News</h3>
    <!-- APPROVED SPORTS ARTICLES LISTED HERE -->
    <ol class="round">
        <li class="one">
