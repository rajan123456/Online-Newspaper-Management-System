...
namespace WebApplication1
{
    ...
    {
        //FETCH APPROVED SPORTS ARTICLES ON PAGE LOAD
        protected void Page_Load(object sender, EventArgs e)
        {
            FetchArticleByType();
        }
        //FETCH APPROVED SPORTS ARTICLES FROM DATABASE
        private void FetchArticleByType()
        {
            ...
            using (conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ServerConnection"].ConnectionString))
            {
                ...
                cmd.Parameters.AddWithValue("@type", "Sports");
        ...
        //DSIPLAY ARTICLE HEADLINES ON PAGE
